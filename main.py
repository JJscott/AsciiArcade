...
def run():
	...
	ArcadeGame.Assets.load_geometry(gl, 	"asteroid1",	"Assets/Asteroids/Asteroid1.obj", center=True)
	ArcadeGame.Assets.load_geometry(gl, 	"asteroid2",	"Assets/Asteroids/Asteroid2.obj", center=True)
	ArcadeGame.Assets.load_geometry(gl, 	"asteroid3",	"Assets/Asteroids/Asteroid3.obj", center=True)
	ArcadeGame.Assets.load_geometry(gl, 	"asteroid4",	"Assets/Asteroids/Asteroid4.obj", center=True)
	ArcadeGame.Assets.load_geometry(gl, 	"asteroid5",	"Assets/Asteroids/Asteroid5.obj", center=True)
	ArcadeGame.Assets.load_geometry(gl, 	"asteroid6",	"Assets/Asteroids/Asteroid6.obj", center=True)
	ArcadeGame.Assets.load_geometry(gl, 	"asteroid7",	"Assets/Asteroids/Asteroid7.obj", center=True)
